...
summary(SG_sub$phthalates)
sd(SG_sub$SG, na.rm=TRUE)

SG_sub[is.na(SG) & !is.na(phthalates), .N] #101 does not have SG among complete #phthalates data 
SG_sub[!is.na(SG) & !is.na(phthalates), .N] #847 has SG
